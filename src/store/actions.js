...
export const addArmy = (data, url) => {
  return {
    type: actionTypes.ADD_ARMY,
    data,
    url,
  };
};

export const addArmySuccess = (data) => {
  return {
    type: actionTypes.ADD_ARMY_SUCCESS,
    data,
  };
};

export const addArmyFail = (error) => {
  return {
    type: actionTypes.ADD_ARMY_FAIL,
    error,
  };
};
